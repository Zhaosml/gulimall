<template>
  <el-dialog
    ...
    <el-form-item label="满减条件" prop="fullPrice">
      <el-input v-model="dataForm.fullPrice" placeholder="满减条件"></el-input>
    </el-form-item>
    <el-form-item label="减免金额" prop="reducePrice">
      <el-input v-model="dataForm.reducePrice" placeholder="减免金额"></el-input>
    </el-form-item>
    <el-form-item label="是否叠加其他优惠" prop="addOther">
      <el-input v-model="dataForm.addOther" placeholder="是否叠加其他优惠"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          fullPrice: [
            { required: true, message: '满减条件不能为空', trigger: 'blur' }
          ],
          reducePrice: [
            { required: true, message: '减免金额不能为空', trigger: 'blur' }
          ],
          addOther: [
            { required: true, message: '是否叠加其他优惠不能为空', trigger: 'blur' }
          ]
        }
      }
    },
