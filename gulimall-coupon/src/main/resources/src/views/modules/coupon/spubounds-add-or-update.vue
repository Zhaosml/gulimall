<template>
  <el-dialog
    ...
    <el-form-item label="优惠券工作状态[1111四个状态位，从右到左分别表示：积分规则是否开启；0 - 未使用积分相关功能；1 - 使用成长积分功能；2 - 使用购物积分功能；3 - 使用成长积分和购物积分功能；状态位0表示未开启，1表示开启]" prop="work">
      <el-input v-model="dataForm.work" placeholder="优惠券工作状态[1111四个状态位，从右到左分别表示：积分规则是否开启；0 - 未使用积分相关功能；1 - 使用成长积分功能；2 - 使用购物积分功能；3 - 使用成长积分和购物积分功能；状态位0表示未开启，1表示开启]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          work: [
            { required: true, message: '优惠券工作状态[1111四个状态位，从右到左分别表示：积分规则是否开启；0 - 未使用积分相关功能；1 - 使用成长积分功能；2 - 使用购物积分功能；3 - 使用成长积分和购物积分功能；状态位0表示未开启，1表示开启]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
