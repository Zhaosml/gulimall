<template>
  <el-dialog
    ...
    <el-form-item label="场次id" prop="sessionId">
      <el-input v-model="dataForm.sessionId" placeholder="场次id"></el-input>
    </el-form-item>
    ...
    <el-form-item label="通知方式[0-站内信；1-邮件]" prop="noticeType">
      <el-input v-model="dataForm.noticeType" placeholder="通知方式[0-站内信；1-邮件]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          noticeType: [
            { required: true, message: '通知方式[0-站内信；1-邮件]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
