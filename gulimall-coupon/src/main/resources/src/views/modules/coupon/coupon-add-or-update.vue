<template>
  <el-dialog
    ...
    <el-form-item label="优惠券类型[0->全场券；1->会员券；2->品类券；3->SPU券]" prop="couponType">
      <el-input v-model="dataForm.couponType" placeholder="优惠券类型[0->全场券；1->会员券；2->品类券；3->SPU券]"></el-input>
    </el-form-item>
    ...
    <el-form-item label="每人限领" prop="perLimit">
      <el-input v-model="dataForm.perLimit" placeholder="每人限领"></el-input>
    </el-form-item>
    ...
    <el-form-item label="领取数量" prop="publishCount">
      <el-input v-model="dataForm.publishCount" placeholder="领取数量"></el-input>
    </el-form-item>
    <el-form-item label="使用数量" prop="useCount">
      <el-input v-model="dataForm.useCount" placeholder="使用数量"></el-input>
    </el-form-item>
    ...
    <el-form-item label="会员领取的最高等级[0->不限等级，其他-对应等级]" prop="memberLevel">
      <el-input v-model="dataForm.memberLevel" placeholder="会员领取的最高等级[0->不限等级，其他-对应等级]"></el-input>
    </el-form-item>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          couponType: [
            { required: true, message: '优惠券类型[0->全场券；1->会员券；2->品类券；3->SPU券]不能为空', trigger: 'blur' }
          ],
          couponImg: [
          ...
          memberLevel: [
            { required: true, message: '会员领取的最高等级[0->不限等级，其他-对应等级]不能为空', trigger: 'blur' }
          ],
          publish: [
