<template>
  <el-dialog
    ...
    <el-form-item label="满足的商品数量" prop="fullCount">
      <el-input v-model="dataForm.fullCount" placeholder="满足的商品数量"></el-input>
    </el-form-item>
    <el-form-item label="折扣" prop="discount">
      <el-input v-model="dataForm.discount" placeholder="折扣"></el-input>
    </el-form-item>
    <el-form-item label="打折后的价格" prop="price">
      <el-input v-model="dataForm.price" placeholder="打折后的价格"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          price: [
            { required: true, message: '打折后的价格不能为空', trigger: 'blur' }
          ],
          addOther: [
