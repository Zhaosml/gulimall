<template>
  <el-dialog
    ...
    <el-form-item label="级别名称" prop="name">
      <el-input v-model="dataForm.name" placeholder="级别名称"></el-input>
    </el-form-item>
    <el-form-item label="级别需要的成长值" prop="growthPoint">
      <el-input v-model="dataForm.growthPoint" placeholder="级别需要的成长值"></el-input>
    </el-form-item>
    <el-form-item label="是否为默认级别[0->否，1->是]" prop="defaultStatus">
      <el-input v-model="dataForm.defaultStatus" placeholder="是否为默认级别[0->否，1->是]"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          growthPoint: [
            { required: true, message: '级别需要的成长值不能为空', trigger: 'blur' }
          ],
          defaultStatus: [
            { required: true, message: '是否为默认级别[0->否，1->是]不能为空', trigger: 'blur' }
          ],
          freeFreightPoint: [
