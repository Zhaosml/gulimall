<template>
  <el-dialog
    ...
    <el-form-item label="变化值，正数为增加，负数为减少" prop="changeCount">
      <el-input v-model="dataForm.changeCount" placeholder="变化值，正数为增加，负数为减少"></el-input>
    </el-form-item>
    <el-form-item label="备注" prop="note">
      <el-input v-model="dataForm.note" placeholder="备注"></el-input>
    </el-form-item>
    <el-form-item label="变化来源[0-系统，1-管理员修改]" prop="sourceType">
      <el-input v-model="dataForm.sourceType" placeholder="变化来源[0-系统，1-管理员修改]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          changeCount: [
            { required: true, message: '变化值，正数为增加，负数为减少不能为空', trigger: 'blur' }
          ],
          note: [
            { required: true, message: '备注不能为空', trigger: 'blur' }
          ],
          sourceType: [
            { required: true, message: '变化来源[0-系统，1-管理员修改]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
