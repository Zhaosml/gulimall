<template>
  <el-dialog
    ...
    <el-form-item label="变化值" prop="changeCount">
      <el-input v-model="dataForm.changeCount" placeholder="变化值"></el-input>
    </el-form-item>
    <el-form-item label="备注" prop="note">
      <el-input v-model="dataForm.note" placeholder="备注"></el-input>
    </el-form-item>
    <el-form-item label="来源[0->系统，1->管理员修改；2->活动]" prop="sourceType">
      <el-input v-model="dataForm.sourceType" placeholder="来源[0->系统，1->管理员修改；2->活动]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          sourceType: [
            { required: true, message: '来源[0->系统，1->管理员修改；2->活动]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
