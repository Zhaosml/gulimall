<template>
  <el-dialog
    ...
    <el-form-item label="累计优惠券金额" prop="couponAmount">
      <el-input v-model="dataForm.couponAmount" placeholder="累计优惠券金额"></el-input>
    </el-form-item>
    ...
    <el-form-item label="退货订单数量" prop="returnOrderCount">
      <el-input v-model="dataForm.returnOrderCount" placeholder="退货订单数量"></el-input>
    </el-form-item>
    ...
    <el-form-item label="收藏商品数量" prop="collectProductCount">
      <el-input v-model="dataForm.collectProductCount" placeholder="收藏商品数量"></el-input>
    </el-form-item>
    <el-form-item label="收藏专题数量" prop="collectSubjectCount">
      <el-input v-model="dataForm.collectSubjectCount" placeholder="收藏专题数量"></el-input>
    </el-form-item>
    <el-form-item label="收藏评论数量" prop="collectCommentCount">
      <el-input v-model="dataForm.collectCommentCount" placeholder="收藏评论数量"></el-input>
    </el-form-item>
    <el-form-item label="邀请朋友数量" prop="inviteFriendCount">
      <el-input v-model="dataForm.inviteFriendCount" placeholder="邀请朋友数量"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          couponAmount: [
            { required: true, message: '累计优惠券金额不能为空', trigger: 'blur' }
          ],
          orderCount: [
          ...
          returnOrderCount: [
            { required: true, message: '退货订单数量不能为空', trigger: 'blur' }
          ],
          loginCount: [
          ...
          collectProductCount: [
            { required: true, message: '收藏商品数量不能为空', trigger: 'blur' }
          ],
          collectSubjectCount: [
            { required: true, message: '收藏专题数量不能为空', trigger: 'blur' }
          ],
          collectCommentCount: [
            { required: true, message: '收藏评论数量不能为空', trigger: 'blur' }
          ],
          inviteFriendCount: [
            { required: true, message: '邀请朋友数量不能为空', trigger: 'blur' }
          ]
        }
      }
    },
