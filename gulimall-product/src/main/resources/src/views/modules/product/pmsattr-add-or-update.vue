<template>
  <el-dialog
    ...
    <el-form-item label="属性状态[0 - 禁用，1 - 启用]" prop="enable">
      <el-input v-model="dataForm.enable" placeholder="属性状态[0 - 禁用，1 - 启用]"></el-input>
    </el-form-item>
    <el-form-item label="所属分类" prop="catelogId">
      <el-input v-model="dataForm.catelogId" placeholder="所属分类"></el-input>
    </el-form-item>
    <el-form-item label="显示描述是否显示在sku上[0-不显示，1-显示]" prop="showDesc">
      <el-input v-model="dataForm.showDesc" placeholder="显示描述是否显示在sku上[0-不显示，1-显示]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          enable: [
            { required: true, message: '属性状态[0 - 禁用，1 - 启用]不能为空', trigger: 'blur' }
          ],
          catelogId: [
            { required: true, message: '所属分类不能为空', trigger: 'blur' }
          ],
          showDesc: [
            { required: true, message: '显示描述是否显示在sku上[0-不显示，1-显示]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
