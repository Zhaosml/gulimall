<template>
  <el-dialog
    ...
    <el-form-item label="所属目录id" prop="catalogId">
      <el-input v-model="dataForm.catalogId" placeholder="所属目录id"></el-input>
    </el-form-item>
    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/product/pmsspuinfo/info/${this.dataForm.id}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/product/pmsspuinfo/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
