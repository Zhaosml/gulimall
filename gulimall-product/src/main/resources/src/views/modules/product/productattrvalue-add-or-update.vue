<template>
  <el-dialog
    ...
    <el-form-item label="是否展示[0-否，1-是]" prop="quickShow">
      <el-input v-model="dataForm.quickShow" placeholder="是否展示[0-否，1-是]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          quickShow: [
            { required: true, message: '是否展示[0-否，1-是]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
