<template>
  <el-dialog
    ...
    <el-form-item label="是否显示[0-不显示，1-显示]" prop="showStatus">
      <el-input v-model="dataForm.showStatus" placeholder="是否显示[0-不显示，1-显示]"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          showStatus: [
            { required: true, message: '是否显示[0-不显示，1-显示]不能为空', trigger: 'blur' }
          ],
          sort: [
