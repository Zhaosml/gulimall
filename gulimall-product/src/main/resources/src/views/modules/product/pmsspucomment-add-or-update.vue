<template>
  <el-dialog
    ...
    <el-form-item label="评星" prop="star">
      <el-input v-model="dataForm.star" placeholder="评星"></el-input>
    </el-form-item>
    ...
    <el-form-item label="商品属性" prop="spuAttributes">
      <el-input v-model="dataForm.spuAttributes" placeholder="商品属性"></el-input>
    </el-form-item>
    ...
    <el-form-item label="资源图片/视频[json数据，[{type:文件类型,url:资源路径}]]" prop="resources">
      <el-input v-model="dataForm.resources" placeholder="资源图片/视频[json数据，[{type:文件类型,url:资源路径}]]"></el-input>
    </el-form-item>
    ...
    <el-form-item label="评论类型[0 - 直接评价，1 - 追评]" prop="commentType">
      <el-input v-model="dataForm.commentType" placeholder="评论类型[0 - 直接评价，1 - 追评]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          resources: [
            { required: true, message: '资源图片/视频[json数据，[{type:文件类型,url:资源路径}]]不能为空', trigger: 'blur' }
          ],
          content: [
          ...
          commentType: [
            { required: true, message: '评论类型[0 - 直接评价，1 - 追评]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
