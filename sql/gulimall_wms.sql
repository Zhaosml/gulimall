/*gulimaill_wms       gulimaill_ware    库存系统*/
...
CREATE TABLE `undo_log` (
                            ...
                            PRIMARY KEY (`id`),
                            UNIQUE KEY `ux_undo_log` USING BTREE (`xid`, `branch_id`)
...
CREATE TABLE `wms_purchase` (
                                ...
                                PRIMARY KEY (`id`)
) ENGINE = InnoDB CHARSET = utf8mb4 COMMENT '采购信息';
...
CREATE TABLE `wms_ware_info` (
                                 ...
                                 PRIMARY KEY (`id`)
) ENGINE = InnoDB CHARSET = utf8mb4 COMMENT '仓库信息';
...
CREATE TABLE `wms_ware_order_task` (
                                       ...
                                       PRIMARY KEY (`id`)
) ENGINE = InnoDB CHARSET = utf8mb4 COMMENT '库存工作单';
...
CREATE TABLE `wms_ware_sku` (
                                ...
                                KEY `ware_id` USING BTREE (`ware_id`)
) ENGINE = InnoDB CHARSET = utf8mb4 COMMENT '商品库存';
