<template>
  <el-dialog
    ...
    <el-form-item label="商品品牌" prop="spuBrand">
      <el-input v-model="dataForm.spuBrand" placeholder="商品品牌"></el-input>
    </el-form-item>
    ...
    <el-form-item label="商品sku名称" prop="skuName">
      <el-input v-model="dataForm.skuName" placeholder="商品sku名称"></el-input>
    </el-form-item>
    ...
    <el-form-item label="商品促销优化金额" prop="promotionAmount">
      <el-input v-model="dataForm.promotionAmount" placeholder="商品促销优化金额"></el-input>
    </el-form-item>
    ...
    <el-form-item label="商品实际支付金额" prop="realAmount">
      <el-input v-model="dataForm.realAmount" placeholder="商品实际支付金额"></el-input>
    </el-form-item>
    <el-form-item label="赠送的积分" prop="giftIntegration">
      <el-input v-model="dataForm.giftIntegration" placeholder="赠送的积分"></el-input>
    </el-form-item>
    <el-form-item label="赠送的成长值" prop="giftGrowth">
      <el-input v-model="dataForm.giftGrowth" placeholder="赠送的成长值"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          skuName: [
            { required: true, message: '商品sku名称不能为空', trigger: 'blur' }
          ],
          skuPic: [
          ...
          promotionAmount: [
            { required: true, message: '商品促销优化金额不能为空', trigger: 'blur' }
          ],
          couponAmount: [
          ...
          realAmount: [
            { required: true, message: '商品实际支付金额不能为空', trigger: 'blur' }
          ],
          giftIntegration: [
            { required: true, message: '赠送的积分不能为空', trigger: 'blur' }
          ],
          giftGrowth: [
            { required: true, message: '赠送的成长值不能为空', trigger: 'blur' }
          ]
        }
      }
    },
