<template>
  <el-dialog
    ...
    <el-form-item label="退货订单id" prop="orderReturnId">
      <el-input v-model="dataForm.orderReturnId" placeholder="退货订单id"></el-input>
    </el-form-item>
    <el-form-item label="退款金额" prop="refund">
      <el-input v-model="dataForm.refund" placeholder="退款金额"></el-input>
    </el-form-item>
    <el-form-item label="退款申请号" prop="refundSn">
      <el-input v-model="dataForm.refundSn" placeholder="退款申请号"></el-input>
    </el-form-item>
    <el-form-item label="退款状态" prop="refundStatus">
      <el-input v-model="dataForm.refundStatus" placeholder="退款状态"></el-input>
    </el-form-item>
    <el-form-item label="退款渠道[1-支付宝；2-微信；3-银联；4-线下退款]" prop="refundChannel">
      <el-input v-model="dataForm.refundChannel" placeholder="退款渠道[1-支付宝；2-微信；3-银联；4-线下退款]"></el-input>
    </el-form-item>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          orderReturnId: [
            { required: true, message: '退货订单id不能为空', trigger: 'blur' }
          ],
          refund: [
            { required: true, message: '退款金额不能为空', trigger: 'blur' }
          ],
          refundSn: [
            { required: true, message: '退款申请号不能为空', trigger: 'blur' }
          ],
          refundStatus: [
            { required: true, message: '退款状态不能为空', trigger: 'blur' }
          ],
          refundChannel: [
            { required: true, message: '退款渠道[1-支付宝；2-微信；3-银联；4-线下退款]不能为空', trigger: 'blur' }
          ],
          refundContent: [
