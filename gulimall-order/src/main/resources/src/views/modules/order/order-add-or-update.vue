<template>
  <el-dialog
    ...
    <el-form-item label="应付金额" prop="payAmount">
      <el-input v-model="dataForm.payAmount" placeholder="应付金额"></el-input>
    </el-form-item>
    ...
    <el-form-item label="管理员后台调整订单使用的折扣金额" prop="discountAmount">
      <el-input v-model="dataForm.discountAmount" placeholder="管理员后台调整订单使用的折扣金额"></el-input>
    </el-form-item>
    ...
    <el-form-item label="自动确认收货时间（天）" prop="autoConfirmDay">
      <el-input v-model="dataForm.autoConfirmDay" placeholder="自动确认收货时间（天）"></el-input>
    </el-form-item>
    ...
    <el-form-item label="可以活动的成长值" prop="growth">
      <el-input v-model="dataForm.growth" placeholder="可以活动的成长值"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          discountAmount: [
            { required: true, message: '管理员后台调整订单使用的折扣金额不能为空', trigger: 'blur' }
          ],
          payType: [
          ...
          growth: [
            { required: true, message: '可以活动的成长值不能为空', trigger: 'blur' }
          ],
          billType: [
